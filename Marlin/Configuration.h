...
#define HEATER_0_MINTEMP   0  //original setting 5
...
#define HEATER_0_MAXTEMP 2375  // original setting 275
...
#define DELTA
  ...
  #define PRINTABLE_RADIUS       61.7   // (mm)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 150, 25 }    // Lower than my original suggestion for safety
...
#define INVERT_E0_DIR false //original true
