...
#define STRING_CONFIG_H_AUTHOR "(DubiousBiscuit)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "DubiousBiscuit Delta V1"
 ...
 */
#define TEMP_SENSOR_0 1 // original setting 11
...
#define TEMP_SENSOR_BED 1 // original setting 11
...
#define HEATER_0_MINTEMP   5  //original setting 5
...
#define HEATER_0_MAXTEMP 275  // original setting 275
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp  24.62  //14.0
  #define DEFAULT_bedKi   3.71  //0.9
  #define DEFAULT_bedKd   40.85 //120.4
...
#define DELTA
  ...
  #define DELTA_AUTO_CALIBRATION
    ...
    // Step size for paper-test probing
     #define PROBING_MARGIN  50.0 // (mm)
    #define PROBE_MANUALLY_STEP 0.05      // (mm)
  #endif

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define PRINTABLE_RADIUS  55.0   // (mm)
  #define PROBABLE_RADIUS   (PRINTABLE_RADIUS - 5)   // (mm) Distance from center to vertical tower axis

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 120.8        // (mm) (Mini Delta arm length)

 // added per grok for mpmdv1
  #define DELTA_SMOOTH_ROD_OFFSET 106.7  // mm
  #define DELTA_EFFECTOR_OFFSET 22.5     // mm
  #define DELTA_CARRIAGE_OFFSET 22.5     // mm
  #define PROBING_MARGIN_BACK 61.7  // mm (effective radius)
  ...
  #define DELTA_RADIUS 63.35              // (mm) Get this value from G33 auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT    { 80, 80, 80, 424.5 }  // X/Y/Z same for towers; E=424.5 for stock Bowden (tune later) 
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 150, 50 }    // Lower than my original suggestion for safety
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION     { 800, 800, 800, 10000 }   // { 1000, 1000, 1000, 10000 }
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN PC14
...
//#define PROBING_TOOL 0 //originally uncommented
#ifdef PROBING_TOOL
...
#define PROBING_MARGIN 0 //original 10

// Leave undefined to use the average of the current XY homing feedrate.
#define XY_PROBE_FEEDRATE   4000 // (30*60)  //orignal (133*60) // (mm/min)

// Feedrate for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (HOMING_FEEDRATE_Z / 5)  //ORIGINAL (4*60) // (mm/min)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   5// 10 (mm) Z Clearance for Deploy/Stow
...
#define Z_CLEARANCE_FOR_HOMING  10   // 4 (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define PROBING_MARGIN_LEFT -(PRINTABLE_RADIUS -(MIN_PROBE_EDGE))
  #define PROBING_MARGIN_RIGHT (PRINTABLE_RADIUS -(MIN_PROBE_EDGE))
  #define PROBING_MARGIN_FRONT -(PRINTABLE_RADIUS -(MIN_PROBE_EDGE))
  #define PROBING_MARGIN_BACK (PRINTABLE_RADIUS -(MIN_PROBE_EDGE))
...
#define MANUAL_Z_HOME_POS DELTA_HEIGHT  //0
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_CENTER ((X_MIN_POS + X_MAX_POS) / 2) // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT Y_CENTER  ((Y_MIN_POS + Y_MAX_POS) / 2) // (mm) Y point for Z homing
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), 0, 20 } //{ (X_MIN_POS + 10), (Y_MAX_POS - 10), 20 }
