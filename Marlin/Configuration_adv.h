...
#define USE_CONTROLLER_FAN // Malyan M200: uncomment if you use FAN2 to cool the board (original)
  ...
  //#define CONTROLLER_FAN2_PIN PB15  //-1          // Set a custom pin for second controller fan
...
#define E0_AUTO_FAN_PIN  PC7  //-1 //Malyan M200: uncomment if you use FAN1 to cool the extruder and the part (original)
...
//EEPROM
#define EEPROM_AUTO_INIT  // Initialize EEPROM with default settings on first run
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.0        // (mm) Compression length applying to all extruders originally 0.22 
  #endif
  #define DEFAULT_EJERK 5.0      // (mm/s) Default extruder jerk used for acceleration limiting
  #define IMPROVED_RETRACTION     // Better for Bowden Deltas
